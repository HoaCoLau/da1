...
<body>
    ...
    <div class="banner">
        <img id="pic" src="uploads/slider-4.jpg" alt="">
        <div class="in-content">
            ...
            <button id="right" onclick="next()"><i class="fa-solid fa-arrow-right"></i></button>
        </div>
        <div id="list">
            <ul>
    ...
    <div class="box-bg">
        <div class="box-img">
            <img class="pic-animation" src="uploads/text-animation.png" alt="">
            <img class="pic-chair" src="uploads/img-1.png" alt="">
        </div>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" width="512" height="512" x="0" y="0" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512" xml:space="preserve">
                        <g>
                            <g xmlns="http://www.w3.org/2000/svg">
                                <g>
                                    <path d="M414.004,303.627c-32.482,0-58.907,26.426-58.907,58.908c0,32.476,26.426,58.902,58.907,58.902    c32.487,0,58.908-26.426,58.908-58.902C472.912,330.053,446.486,303.627,414.004,303.627z M414.004,388.399    c-14.27,0-25.875-11.605-25.875-25.87c0-14.27,11.605-25.875,25.875-25.875s25.875,11.611,25.875,25.875    C439.88,376.793,428.274,388.399,414.004,388.399z" fill="" data-original=""></path>
                                </g>
                            </g>
                            <g xmlns="http://www.w3.org/2000/svg">
                                <g>
                                    <path d="M329.221,90.563H16.516C7.394,90.563,0,97.957,0,107.08v254.348c0,9.122,7.394,16.516,16.516,16.516h51.751v-33.032    H33.032V123.596h279.673v237.832h33.032V107.08C345.738,97.957,338.344,90.563,329.221,90.563z" fill="" data-original=""></path>
                                </g>
                            </g>
                            <g xmlns="http://www.w3.org/2000/svg">
                                <g>
                                    <rect x="149.196" y="344.912" width="222.417" height="33.032" fill="" data-original=""></rect>
                                </g>
                            </g>
                            <g xmlns="http://www.w3.org/2000/svg">
                                <g>
                                    <path d="M108.456,303.627c-32.482,0-58.908,26.426-58.908,58.908c0,32.476,26.426,58.902,58.908,58.902    c32.482,0,58.908-26.426,58.908-58.902C167.363,330.053,140.938,303.627,108.456,303.627z M108.456,388.399    c-14.27,0-25.875-11.605-25.875-25.87c0-14.27,11.605-25.875,25.875-25.875c14.27,0,25.875,11.611,25.875,25.875    C134.331,376.793,122.72,388.399,108.456,388.399z" fill="" data-original=""></path>
                                </g>
                            </g>
                            <g xmlns="http://www.w3.org/2000/svg">
                                <g>
                                    <path d="M495.484,227.647H329.221v33.032h149.746v84.232h-23.673v33.032h40.189c9.122,0,16.516-7.388,16.516-16.516V244.163    C512,235.041,504.606,227.647,495.484,227.647z" fill="" data-original=""></path>
                                </g>
                            </g>
                            <g xmlns="http://www.w3.org/2000/svg">
                                <g>
                                    <path d="M445.545,159.127c-2.901-5.274-8.451-8.555-14.474-8.555H329.221v33.032h92.083l37.684,68.52l28.947-15.922    L445.545,159.127z" fill="" data-original=""></path>
                                </g>
                            </g>
    ...
    <div class="all-box-banner">
        <div class="box-first-banner">
            <div class="box-img-banner">
                <a href="">
                    <img src="uploads/banner-6-1.jpg" alt="">
                </a>
            </div>
        ...
        <div class="box-first-banner">
            <div class="box-img-banner">
                <a href="">
                    <img src="uploads/banner-7-1.jpg" alt="">
                </a>
            </div>
            <div class="title-in-banner">
    ...
    <div class="box-brand">
        <div class="in-brand">
            <a href="">
                <img src="uploads/brand-1-1.jpg" alt="">
            </a>
            <a href="">
                <img src="uploads/brand-2-1.jpg" alt="">
            </a>
            <a href="">
                <img src="uploads/brand-3-1.jpg" alt="">
            </a>
            <a href="">
                <img src="uploads/brand-4-1.jpg" alt="">
            </a>
            <a href="">
                <img src="uploads/brand-5-1.jpg" alt="">
            </a>
        </div>
    </div>
    <!-- Phần footer -->
