...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-11">
          <h1>Form sửa sản phẩm <?= $sanPham['ten_san_pham'] ?></h1>
        </div>
        <div class="col-sm-1" >
    ...
    <div class="row">
      <div class="col-md-8">
        <div class="card card-primary">
          ...
          <form action=" <?= BASE_URL_ADMIN . '?act=post-update-san-pham' ?> " method="post" enctype="multipart/form-data">
            <div class="card-body">
      ...
      <div class="col-md-4">
        ...
        <div class="card card-info">
          ...
          <div class="card-body p-0">
            <form action=" <?= BASE_URL_ADMIN . '?act=update-anh-san-pham' ?> " method="post" enctype="multipart/form-data">
                ...
                <table id="faqs" class="table table-hover">
                  ...
                  <tbody>
                    ...
                    <tr id="faqs-row-<?= $key ?>" >
                      ...
                      <td><img src="<?= BASE_URL . $value['link_hinh_anh'] ?>" style="width: 50px;" alt=""></td>
...
<script>
  ...
  function addfaqs() {
    ...
    html += '<td><img src="https://nhaxinh.com/wp-content/uploads/2024/01/nha-xinh-do-trang-tri-banner-31-1-24.jpg" style="width: 50px;" alt=""></td>';
