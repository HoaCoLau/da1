...
var img = [
    "./uploads/slider-4.jpg",
    "./uploads/slider-5.jpg",
    "./uploads/slider-6.jpg",
];
...
firstImg.addEventListener('mouseover', function() {
    firstImg.src = "./uploads/products-8-600x600.jpg";
});

firstImg.addEventListener('mouseout', function() {
    firstImg.src = "./uploads/products-7-600x600.jpg";
});
// -----------------------------------------------
...
firstImg_1.addEventListener('mouseover', function() {
    firstImg_1.src = "./uploads/img-16-600x600.jpg";
});

firstImg_1.addEventListener('mouseout', function() {
    firstImg_1.src = "./uploads/img-15-9-600x600.jpg";
});
// -----------------------------------------------
...
firstImg_2.addEventListener('mouseover', function() {
    firstImg_2.src = "./uploads/products-2-600x600.jpg";
});

firstImg_2.addEventListener('mouseout', function() {
    firstImg_2.src = "./uploads/products-1-600x600.jpg";
});
// -----------------------------------------------
